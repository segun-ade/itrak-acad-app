...
/*!50001 VIEW `login_view` AS select `itrak_user`.`email_addr` AS `email_addr`,`itrak_user`.`pwd` AS `pwd`,`itrak_user`.`user_type` AS `user_type` from `itrak_user` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Dumping events for database 'logindb'
--
...
-- Dump completed on 2024-12-11 21:52:48
